...
var getAllOutput = document.getElementById("getAll");
var url = "http://cars-rest.azurewebsites.net/api/Meassurement";
//GetOne
var inputGetone = document.getElementById("getoneInput");
var getoneButton = document.getElementById("getoneButton");
getoneButton.addEventListener("click", getOneMeassurement);
var getoneOutput = document.getElementById("getOne");
//Post
var postButton = document.getElementById("addButton");
...
function getOneMeassurement() {
    var id = inputGetone.value;
    if (id.length > 0) {
        _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(url + "/" + id)
            .then(function (response) {
            var measure = response.data;
            var longHtml2 = "<ol>";
            console.log(measure);
...
function addMeassurement() {
    var PressureinputElement = document.getElementById("addPressure");
    var HumidinputElement = document.getElementById("addHumidity");
    var TempinputElement = document.getElementById("addTemp");
    var addoutputElement = document.getElementById("postOutput");
    var myPressure = Number(PressureinputElement.value);
    var myHumidity = Number(HumidinputElement.value);
    var myTemperature = Number(TempinputElement.value);
    _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.post(url, { pressure: myPressure, humdity: myHumidity, temperature: myTemperature })
        .then(function (response) {
        var message = "<h6 id='responseMessage'>" + response.status + " " + response.statusText + "</h6>";
...
function deleteMeassurement() {
    ...
    var output = document.getElementById("deletedMeasurementOutput");
    var urlDelete = url + "/" + id;
    if (id.length > 0) {
        _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.delete(urlDelete)
            .then(function (response) {
